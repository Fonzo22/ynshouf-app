...
new_block = (
    ...
    "\n"
    "        new D.TableCell({\n"
    "          width: { size: 7200, type: D.WidthType.DXA }, borders: noBrds,\n"
    "          verticalAlign: D.VerticalAlign.CENTER,\n"
    "          children: [\n"
    "            new D.Paragraph({\n"
    "              bidirectional: true, alignment: D.AlignmentType.RIGHT,\n"
    "              spacing: { before: 0, after: 60 },\n"
    "              border: { bottom: { style: D.BorderStyle.SINGLE, size: 4, color: '1A7A4A', space: 6 }},\n"
    ...
    "\n"
    "        new D.TableCell({\n"
    "          width: { size: 1800, type: D.WidthType.DXA }, borders: noBrds,\n"
    "          verticalAlign: D.VerticalAlign.CENTER,\n"
