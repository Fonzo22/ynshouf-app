...
old_end   = src.index('    var children = [headerTable];')
...
new_block = (
    ...
    "\n"
    "        new D.TableCell({\n"
    "          width: { size: 6500, type: D.WidthType.DXA }, borders: noBrds,\n"
    ...
    "              children: [run('הרשות לשמירת הטבע והגנים הלאומיים', { bold: true, size: 24, color: '1A7A4A' })]\n"
    "            }),\n"
    "            new D.Paragraph({\n"
    "              bidirectional: true, alignment: D.AlignmentType.RIGHT,\n"
    "              spacing: { after: 0 },\n"
